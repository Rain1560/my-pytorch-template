...
current_dir = Path()
assert (current_dir / 'startproject.py').is_file(), 'Script should be executed in the pytorch-template directory'
...
ignore = [".git", "data", "saved", "startproject.py", "LICENSE", ".flake8", "README.md", "__pycache__"]
